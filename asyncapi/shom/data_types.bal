...
public type GenericDataType Address|OrderAdjustment|Customer|TotalTaxSet|ProductImage|DiscountApplication|PriceSet|PaymentTerms|DiscountedPriceSet|TaxLine|CustomerEvent|TotalPriceSet|TotalLineItemsPriceSet|TotalDiscountSet|PresentmentPrices|ProductVariant|FulfillmentEvent|Property|RefundLineItem|ProductEvent|ProductOption|TotalShippingPriceSet|Receipt|CurrentTotalDutiesSet|PaymentSchedule|ShippingLine|Metafield|TotalDiscountsSet|LineItem|DiscountCode|CurrentTotalDutiesSetObject|NoteAttribute|Fulfillment|OriginalTotalDutiesSetObject|SmsMarketingConsent|Refund|Price|AmountSet|OrderEvent|OriginalTotalDutiesSet|OrderLineItem|Option|PresentmentPrice|SubtotalPriceSet|DiscountAllocations|CustomerAddress;
